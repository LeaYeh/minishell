...
/*   Updated: 2024/03/31 23:59:46 by ldulling         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	compare_non_equal_alnum(const char *str1, const char *str2);
static int	compare_equal_alnum(const char *str1, const char *str2);
static int	compare_non_equal_non_alnum(const char *str1, const char *str2);
