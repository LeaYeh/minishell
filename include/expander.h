...
int			get_replace_len(
				char *str);
bool		is_unquoted_quote(
				char quote);
void		skip_to_dollar_not_in_single_quotes(
				char *str,
				int *i);

/* null_expansion.c */
void		drop_null_expansion_nodes(
				t_list **expanded_list);

/* parameter_expansion.c */
bool		handle_parameter_expansion(
				t_list **task_list,
				t_sh *shell);

/* quote_removal.c */
bool		handle_quote_removal(
				t_list **task_list);
